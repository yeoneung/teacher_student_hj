...
\begin{abstract}\input{current/abstract}\end{abstract}
\begin{keyword}
...
\end{frontmatter}
\clearpage
\section{Introduction}\input{current/introduction}

\input{current/theory}
\input{current/minimal_information}
\input{current/neural_setup}
\input{current/minimal_experiment}
\input{current/neural_information}
\input{current/transfer_limits}
\input{current/discussion}
...
\input{current/minimal_original_results}
\input{current/minimal_comparisons}
\input{current/approximate_experiment}
\input{current/improving_sets}
\input{current/algorithm}
\input{current/protocol}
\input{current/results}
\input{current/set_experiments}
\input{current/dynamics}
\input{current/appendix}
\input{current/set_appendix}
\input{current/set_pilot_tables}
